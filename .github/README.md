...
[`@aws-sdk/client-mediaconvert`](https://www.npmjs.com/package/@aws-sdk/client-mediaconvert/v/3.2.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mediaconvert@3.2.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jqORfBxZfArX7p/70dfQzQdE2WfBPkMeyncz4+xOPtUPwg0KMvL32Z5ptIvf0Byp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-mediaconvert": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mediaconvert@3.2.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-mediaconvert@3.2.0/index.min.mjs": "sha384-jqORfBxZfArX7p/70dfQzQdE2WfBPkMeyncz4+xOPtUPwg0KMvL32Z5ptIvf0Byp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-mediaconvert/blob/refs/tags/3.2.0/LICENSE
```
